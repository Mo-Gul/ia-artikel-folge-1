...
Dokumentation liegt in Office-Formaten, etwa pptx oder xlsx vor.
...
Einige UML-Tools besitzen leistungsfähige Schnittstellen zur Automatisierung,
...
In der zweiten Folge dieses Artikels zeigen wir Ihnen die frei verfügbare
Werkzeugkette docToolchain, mit deren Hilfe Sie
Office-Dokumente integrieren, Word(TM) und Confluence(TM) Formate generieren und noch
andere spannende Dinge erledigen können.
...
// @RDM: sollen wir da noch welche aufnehmen?
