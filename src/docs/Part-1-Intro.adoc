...
Noch mehr Informationen finden Sie in der Zwischenzeit auch auf https://docs-as-co.de[Docs-as-Co.de],
das fertige Beispiel dieser Artikelserie auf https://hsc.aim42.org/[hsc.aim42.org]
und das arc42Template zum Durchstarten mit Ihrer eigenen Dokumentation können Sie auf https://arc42.de/[arc42.de] herunterladen.
