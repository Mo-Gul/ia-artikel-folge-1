...
// RDM: sehe ich mittlerweile genauso, aber ein automatisierter Screenshot aus einem Test heraus macht IMHO weiterhin Sinn...
...
Der Schlüssel zum Docs-as-Code Ansatz ist die Verwendung eines "plain text" formats zur Dokumentation anstelle eines binärformats einer typischen Textverarbeitung.
